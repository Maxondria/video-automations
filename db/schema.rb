...
ActiveRecord::Schema[7.0].define(version: 2022_04_26_211729) do
  ...
  create_table "videos", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.uuid "description_templates_id", null: false
    t.index ["description_templates_id"], name: "index_videos_on_description_templates_id"
  ...
  add_foreign_key "videos", "description_templates", column: "description_templates_id"
end
